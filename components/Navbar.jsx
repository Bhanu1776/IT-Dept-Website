        ...
        <div className="container flex flex-wrap items-center justify-between mx-auto ">
          <a href="#" className="flex items-center">
            <img
              ...
              alt="Flowbite Logo"
            />
            <span class="self-center text-lg text-white font-normal whitespace-nowrap dark:text-white">
          ...
          <div
            class="xxsm:hidden bg-[#202124] w-full md:block md:w-auto"
            id="navbar-multi-level"
          >
            <ul class="flex flex-col p-4 mt-4 border bg-[#202124] border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-[#202124] dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a
                  href="#"
