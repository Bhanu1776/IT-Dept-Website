    ...
    return (
        <div className=' flex h-screen w-full flex-col justify-center items-center'>
            <div className=' w-[420px] gap-2 flex flex-col justify-between items-center p-5 bg-white rounded-lg border-[1px] border-gray-200 shadow-md shadow-gray-200'>{/*Login layout */}
                ...
                <div className=' w-full'>
                    <button onClick={handlePasswordReset} className=' bg-[#214ED3] uppercase tracking-wider text-white hover:opacity-[0.8] active:opacity-[0.5] p-4 rounded-md w-full transition-all ease-in duration-150'>Reset Password</button>
                </div>
