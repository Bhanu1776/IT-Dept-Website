  ...
  return (
    <>
        <div className='2xl:mx-[150px] lg:mx-[150px] xl:mx-[150px]'>
            ...
            >
                <Avatar style={{width:200,height:200,position:'relative',bottom:10}} src="/Assets/images/facultyimg1.png" />
            ...
            >
                <Avatar style={{width:200,height:200,position:'relative',bottom:10}} src="/Assets/images/facultyimg2.png" />
                <Typography style={{'fontWeight':'bold','paddingTop':3,'fontSize':17}}>
                    FR.DR. JOHN ROSE SJ
                </Typography>
                <Typography>
            ...
            >
                <Avatar style={{width:200,height:200,position:'relative',bottom:10}} src="/Assets/images/facultyimg3.png" />
                <Typography style={{'fontWeight':'bold','paddingTop':3,'fontSize':17}}>
            ...
            >
                <Avatar style={{width:200,height:200,position:'relative',bottom:10}} src="/Assets/images/facultyimg4.png" />
                <Typography style={{'fontWeight':'bold','paddingTop':3,'fontSize':17}}>
            ...
            >
                <Avatar style={{width:200,height:200,position:'relative',bottom:10}} src="/Assets/images/facultyimg5.png" />
                <Typography style={{'fontWeight':'bold','paddingTop':3,'fontSize':17}}>
                    JAYCHAND UPADHYAY
                </Typography>
                <Typography>
                ...
                <Button className='mt-1 text-white bg-blue-500'>
                More Detail
                </Button>
            </Card>
            <Card
            ...
            >
                <Avatar style={{width:200,height:200,position:'relative',bottom:10}} src="/Assets/images/facultyimg6.png" />
                <Typography style={{'fontWeight':'bold','paddingTop':3,'fontSize':17}}>
                    MARTINA D'SOUZA
                </Typography>
                <Typography>
            ...
            <Button type="link" className='lg:relative lg:left-[190px] lg:bottom-[530px] text-[20px] overflow-hidden 2xl:relative 2xl:left-[1000px] 2xl:bottom-[280px] xl:relative xl:left-[390px]'>
                View More ...
            </Button>
            </div>
        </div>
